 ...
 */
export function TimeTravelDebugger({ snapshots, nodes, edges, showGantt = true, layout = "horizontal", title = "Time-Travel Debugger", size = "default", unstyled = false, className, style, }) {
            ...
            ...style,
                    ...
                    overflow: "hidden",
                            ...
                            borderBottom: !isHorizontal
                                ? `1px solid ${theme.border}`
                                : "none",
                        }, children: _jsx(FlowchartView, { nodes: nodes, edges: edges, snapshots: snapshots, selectedIndex: selectedIndex, onNodeClick: setSelectedIndex, size: size }) }), _jsxs("div", { style: { flex: 1, overflow: "auto" }, children: [_jsx(MemoryInspector, { snapshots: snapshots, selectedIndex: selectedIndex, size: size }), _jsx("div", { style: {
                                    height: 1,
